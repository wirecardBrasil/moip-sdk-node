...
describe('Moip Subscribers', () => {
  ...
  it('Should successfully create a subscriber', (done) => {
    moip.init(auth).then((client) => {
      client.subscriber.create(subscriber, {new_vault: false})
        .then((response) => {
  ...
  it('Should successfully get a subscriber', (done) => {
    moip.init(auth).then((client) => {
      client.subscriber.getOne(subscriber.code)
        .then((response) => {
  ...
  it('Should successfully update a subscriber', (done) => {
    moip.init(auth).then((client) => {
      client.subscriber.update(subscriber.code, {
  ...
  it('Should successfully update subscriber billing info', (done) => {
    moip.init(auth).then((client) => {
      client.subscriber.updateBilling(subscriber.code, {
        credit_card: {

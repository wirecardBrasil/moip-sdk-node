...
describe('Moip Connect', function () {
  ...
  var client_id = 'APP-H33WKWDW97YL';
  var redirect_uri = 'http://www.moip.com.br/redirect';
  var client_secret = '41c7f270148447b1b57ab8a9afc1306d';
  it('Successfully redirect user to authorization page', function (done) {
    moip.connect.getAuthorizeUrl({
      ...
      chai.assert.include(url, client_id);
      chai.assert.include(url, redirect_uri);
      done()
    })
  })
